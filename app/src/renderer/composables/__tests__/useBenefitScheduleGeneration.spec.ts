...
const mockResultSummaries = [
  {
    ...
    // Risk premium fixtures map back to the previous office premium values
    // through the 0.20 scheme loading (office = risk / 0.8).
    ...
    exp_total_ci_annual_risk_premium: 0,
    total_ci_capped_sum_assured: 0,
    exp_proportion_ci_annual_risk_premium_salary: 0,
    exp_total_sgla_annual_risk_premium: 0,
    total_sgla_capped_sum_assured: 0,
    exp_proportion_sgla_annual_risk_premium_salary: 0,
    exp_total_phi_annual_risk_premium: 0,
    total_phi_capped_income: 0,
    exp_proportion_phi_annual_risk_premium_salary: 0,
    exp_total_ttd_annual_risk_premium: 0,
    total_ttd_capped_income: 0,
    exp_proportion_ttd_annual_risk_premium_salary: 0,
