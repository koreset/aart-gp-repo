...
// Additional GLA Cover summary now lives in AdditionalGlaCoverSummary.vue
// (rendered as its own tab from NewQuoteDetail.vue), so the export helper
// and "any rates" computed flag previously declared here have been removed.
