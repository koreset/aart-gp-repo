<template>
  <div class="kpi-card" :class="`kpi-card--${tone || 'muted'}`">
...
/* Tone variants — accent stripe + icon tint within theme family */
...
.kpi-card--error .kpi-card__stripe {
...
.kpi-card--info .kpi-card__stripe {
