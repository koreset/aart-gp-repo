...
BEGIN
    ALTER TABLE group_pricing_quotes ADD loadings_binder_fee DECIMAL(15,5);
END;
ELSE
BEGIN
    ALTER TABLE group_pricing_quotes ALTER COLUMN loadings_binder_fee DECIMAL(15,5);
END;
...
BEGIN
    ALTER TABLE group_pricing_quotes ADD loadings_outsource_fee DECIMAL(15,5);
END;
ELSE
BEGIN
    ALTER TABLE group_pricing_quotes ALTER COLUMN loadings_outsource_fee DECIMAL(15,5);
END;
