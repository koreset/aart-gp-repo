...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='gla_region_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN gla_region_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN gla_region_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='gla_aids_region_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN gla_aids_region_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN gla_aids_region_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ptd_region_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ptd_region_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ptd_region_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ci_region_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ci_region_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ci_region_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ttd_region_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ttd_region_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ttd_region_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='phi_region_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN phi_region_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN phi_region_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='fun_region_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN fun_region_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN fun_region_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='fun_aids_region_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN fun_aids_region_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN fun_aids_region_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='gla_industry_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN gla_industry_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN gla_industry_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ptd_industry_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ptd_industry_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ptd_industry_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ci_industry_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ci_industry_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ci_industry_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ttd_industry_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ttd_industry_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ttd_industry_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='phi_industry_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN phi_industry_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN phi_industry_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='gla_contingency_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN gla_contingency_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN gla_contingency_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ptd_contingency_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ptd_contingency_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ptd_contingency_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ci_contingency_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ci_contingency_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ci_contingency_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='ttd_contingency_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN ttd_contingency_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN ttd_contingency_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='phi_contingency_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN phi_contingency_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN phi_contingency_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='fun_contingency_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN fun_contingency_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN fun_contingency_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- MySQL: Add or modify column
SET @s = (SELECT IF(
    EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='member_rating_results' AND COLUMN_NAME='continuation_loading' AND TABLE_SCHEMA = DATABASE()),
    'ALTER TABLE member_rating_results MODIFY COLUMN continuation_loading DOUBLE;',
    'ALTER TABLE member_rating_results ADD COLUMN continuation_loading DOUBLE;'
));
PREPARE stmt FROM @s;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
