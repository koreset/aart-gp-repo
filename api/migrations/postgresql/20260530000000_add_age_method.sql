...
ALTER TABLE group_pricing_settings
    ADD COLUMN IF NOT EXISTS age_method VARCHAR(32) NOT NULL DEFAULT 'age_next_birthday';

ALTER TABLE group_pricing_settings
    ADD COLUMN IF NOT EXISTS age_method_updated_at TIMESTAMP NULL;

ALTER TABLE group_pricing_settings
    ADD COLUMN IF NOT EXISTS age_method_updated_by VARCHAR(255) NOT NULL DEFAULT '';
