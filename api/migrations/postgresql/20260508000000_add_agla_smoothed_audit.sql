...
ALTER TABLE scheme_categories
    ADD COLUMN IF NOT EXISTS additional_gla_smoothed_updated_at TIMESTAMP NULL;

ALTER TABLE scheme_categories
    ADD COLUMN IF NOT EXISTS additional_gla_smoothed_updated_by VARCHAR(255) NOT NULL DEFAULT '';
