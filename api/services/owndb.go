...
func (db *OwnDb) BatchInsert(objArr []models.AggregatedProjection) (int64, error) {
...
func splitIntoChunks(objArr []models.AggregatedProjection, numberOfFields int) [][]models.AggregatedProjection {
	var chunks [][]models.AggregatedProjection
	...
	if numberOfObjects < chunkSize {
		return [][]models.AggregatedProjection{objArr}
	}
...
func (db *OwnDb) batchInsertChunks(chunks [][]models.AggregatedProjection) (int64, error) {
